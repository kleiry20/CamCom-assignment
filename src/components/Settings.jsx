...
export const Settings = ({ isOpen, onClose, children }) => {
      ...
      >
        ...
        <form className="flex justify-between gap-4">
          <div>
            ...
            <section>
              <h3 className="font-semibold  pb-1 pt-2">
                After changing direction with arrow keys
              </h3>
            ...
            {/* Within a word */}
            <section>
              <h3 className="font-semibold pb-1 pt-2">Within a word</h3>
              <div className="flex flex-col">
                <div className="flex gap-2">
                  <input
                    type="checkbox"
          ...
          <div>
            ...
            {/* Interactions */}
            <section>
              <h3 className="font-semibold   pb-1 pt-2">Interactions</h3>
              <div className="flex flex-col">
                <div className="flex gap-2">
                  <input
                    type="checkbox"
        ...
        <div className="flex justify-center mt-4 gap-4">
          <button className="border px-6 py-3 rounded-full" disabled>
            Restore defaults
          </button>
